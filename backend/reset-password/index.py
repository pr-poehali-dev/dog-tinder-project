    ...
    try:
        ...
        if unisender_api_key and unisender_sender_email:
            ...
            if response.status_code != 200:
                raise Exception(f'Unisender error: {response.text}')
        else:
            ...
            if not smtp_user or not smtp_password:
                return {
                    ...
                    'body': json.dumps({'error': 'Email отправка не настроена. Обратитесь к администратору'})
                }
            ...
            try:
                ...
                return {
                    ...
                    'body': json.dumps({'error': 'Ошибка SMTP аутентификации. Проверьте настройки email'})
                }
